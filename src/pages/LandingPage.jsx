    ...
    <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <nav className="flex justify-between items-center px-6 md:px-12 py-5 bg-white dark:bg-gray-900 shadow-md dark:shadow-gray-800 relative transition-colors duration-300">
          ...
          <ul className="hidden md:flex gap-6 items-center">
            ...
            <li>
              <button
                onClick={toggleDark}
                className="text-2xl text-black dark:text-white hover:text-[#99489D] dark:hover:text-[#99489D] transition"
              >
                {isDark ? "☀️" : "🌙"}
              </button>
            </li>
          ...
          {/* Right side for mobile: Dark mode + Hamburger */}
          <div className="flex items-center gap-4 md:hidden">
            <button
              onClick={toggleDark}
              className="text-2xl text-black dark:text-white hover:text-[#99489D] transition"
            >
              {isDark ? "☀️" : "🌙"}
            </button>
      ...
      <section id="hero" className="hero-section">
        <div className="relative bg-black dark:bg-gray-950 text-white flex flex-col md:flex-row items-center justify-start px-6 md:px-12 min-h-[100svh] overflow-hidden transition-colors duration-300">
          ...
          {/* Text Content */}
          <div
            className={`w-full md:w-1/2 text-left flex flex-col justify-center pl-0 md:pl-16 pt-8 md:pt-0 ${
